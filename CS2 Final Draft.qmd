...
\begin{center}
\text{Table 4: Predictors Selected For Each Model}
\end{center}
...
**Question 1:** We see that chemical index, frequency, and cycle number have the most significant effects on both damping and stiffness. However porosity has an effect on damping and amplitude as an effect on stiffness. 
