...
**Question 2:** High frequency, high amplitude, and chemical indices 100 and 121 all increase the initial stiffness, but as time goes on, these also lose stiffness the fastest. Foam with chemical index 121 has the greatest decrease in stiffness. The individual predictors will impact damping in a similar way but foam with a chemical index of 79 and a low porosity will see the greatest decay in damping. Overall, there appear to be significant impacts on the stiffness and damping values depending on chemical index and porosity.
